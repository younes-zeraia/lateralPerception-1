function figClustering = plotClusteringResults(lineTypeMesLeft,lineTypeGTLeft,lineTypeMesRight,lineTypeGTRight,lineColorMesLeft,lineColorGTLeft,lineColorMesRight,lineColorGTRight,...
    ...
    title(axCL(1),strcat('Left  Line Type  \color{red} Hit% \color{black}: [ Solid : \color{blue}',...
                         num2str((clusteringResultsLeft.solid.detected/clusteringResultsLeft.solid.present)*100),'\color{black} % - Dashed : \color{blue}',...
                         num2str((clusteringResultsLeft.dashed.detected/clusteringResultsLeft.dashed.present)*100),'\color{black} % - Road Edge : \color{blue}',...
                         num2str((clusteringResultsLeft.roadEdge.detected/clusteringResultsLeft.roadEdge.present)*100),'\color{black} % ]'));
    title(axCL(2),strcat('Right  Line Type  \color{red} Hit% \color{black}: [ Solid : \color{blue}',...
                         num2str((clusteringResultsRight.solid.detected/clusteringResultsRight.solid.present)*100),'\color{black} % - Dashed : \color{blue}',...
                         num2str((clusteringResultsRight.dashed.detected/clusteringResultsRight.dashed.present)*100),'\color{black} % - Road Edge : \color{blue}',...
                         num2str((clusteringResultsRight.roadEdge.detected/clusteringResultsRight.roadEdge.present)*100),'\color{black} % ]'));
    title(axCL(3),strcat('Line Color  \color{red} Hit% \color{black}: [ White : \color{blue}',...
                         num2str(((clusteringResultsLeft.white.detected/clusteringResultsLeft.white.present)+(clusteringResultsRight.white.detected/clusteringResultsRight.white.present))/2*100),'\color{black} % - Yellow : \color{blue}',...
                         num2str(((clusteringResultsLeft.yellow.detected/clusteringResultsLeft.yellow.present)+(clusteringResultsRight.yellow.detected/clusteringResultsRight.yellow.present))/2*100),'\color{black} % - Blue : \color{blue}',...
                         num2str(((clusteringResultsLeft.blue.detected/clusteringResultsLeft.blue.present)+(clusteringResultsRight.blue.detected/clusteringResultsRight.blue.present))/2*100),'\color{black} % ]'));
