...
%         text(axCurv(1),t(iFallTurn(turn)),turns.curvatureNom2(turn),strcat('\leftarrow \color{black} Error : ',num2str(turns.curvatureError2(turn)*100),'%'));
    ...
    title(axCurv(1),{strcat('\color{blue}',nameCurv1,'\color{black} Curvature (C2) - Mean Error : \color{red}',num2str(nanmean(turns.curvatureError1)*100),'\color{black} %',...   
                     ' / Mean Overshoot : \color{red}',num2str(nanmean(turns.curvatureOvershoot1)*100),'\color{black} %',...
                     ' / Mean Undershoot : \color{red} ',num2str(nanmean(turns.curvatureUndershoot1(turn))*100),'\color{black} %'),...
                     strcat('\color{blue}',nameCurv2,'\color{black} Curvature (C2) - Mean Error : \color{red}',num2str(nanmean(turns.curvatureError2)*100),'\color{black} %',...   
                     ' / Mean Overshoot : \color{red}',num2str(nanmean(turns.curvatureOvershoot2)*100),'\color{black} %',...
                     ' / Mean Undershoot : \color{red} ',num2str(nanmean(turns.curvatureUndershoot2(turn))*100),'\color{black} %')});
