function figQuality = plotQualityResults(measure1Left,measure1Right,measure2Left,measure2Right,...
    ...
    title(axQuality(1),{strcat('\color{blue}',strrep(name1,'_',' '),'\color{black} Left line Quality - Good Quality overall \color{red}',num2str(results1Left.overall*100),'\color{black} %',...
                        ...
                        strcat('\color{red}',strrep(name1,'_',' '),'\color{black} Right line Quality - Good Quality overall \color{red}',num2str(results1Right.overall*100),'\color{black} %',...
    ...
    title(axQuality(2),{strcat('\color{blue}',strrep(name2,'_',' '),'\color{black} Left line Quality - Good Quality overall \color{red}',num2str(results2Left.overall*100),'\color{black} %',...
                        ...
                        strcat('\color{red}',strrep(name2,'_',' '),'\color{black} Right line Quality - Good Quality overall \color{red}',num2str(results2Right.overall*100),'\color{black} %',...
