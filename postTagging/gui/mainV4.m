...
% Last Modified by GUIDE v2.5 04-Apr-2020 21:49:22
...
Signaux=load(fullfile(handles.logCAN(NumCapsule).folder,handles.logCAN(NumCapsule).name));
handles.SignauxName=fieldnames(Signaux);
set(handles.listsignaux, 'string', handles.SignauxName);
Signaux.Line_Marking_Left
